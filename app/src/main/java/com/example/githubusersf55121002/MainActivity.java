package com.example.githubusersf55121002;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("List of Github Users (F55121002)");
        }
        ...
        getListUsers();
        listUsers.setOnItemClickListener(new
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token ghp_b6ge6TXa3dxsJE4Cusat5DqkzU6QdA21ArHu");
